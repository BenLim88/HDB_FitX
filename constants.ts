...
export const MOCK_VENUES: Venue[] = [
    ...
    { id: 'v36', name: 'Nova Training', type: 'Commercial' },
    { id: 'v6', name: 'Open Void Deck', type: 'HDB' },
    { id: 'v40', name: 'PEAK', type: 'Commercial' },
    { id: 'v34', name: 'Project Rally', type: 'Commercial' },
    { id: 'v26', name: 'PURE Fitness', type: 'Commercial' },
    { id: 'v35', name: 'REVL', type: 'Commercial' },
    { id: 'v20', name: 'Ritual', type: 'Commercial' },
    { id: 'v39', name: 'Solitude of Strength', type: 'Commercial' },
    { id: 'v38', name: 'STR Fitness Club', type: 'Commercial' },
    { id: 'v32', name: 'The Strength Yard', type: 'Commercial' },
    { id: 'v37', name: 'Trilogic Fitness', type: 'Commercial' },
...
export const MOCK_EXERCISES: Exercise[] = [
    ...
    // === HYROX / DEADLY DOZEN SPECIFIC ===
    { id: 'kb_farmers', name: 'Farmers Carry (KB)', type: 'distance', category: 'Hyrox' },
    { id: 'kb_deadlift', name: 'Kettlebell Deadlift', type: 'reps', category: 'Hyrox' },
    { id: 'db_lunge', name: 'Dumbbell Lunges', type: 'distance', category: 'Hyrox' },
    { id: 'db_snatch', name: 'Dumbbell Snatch (Alternate)', type: 'reps', category: 'Hyrox' },
    { id: 'goblet_squat', name: 'Goblet Squat (KB)', type: 'reps', category: 'Hyrox' },
    { id: 'wp_front_carry', name: 'Front Carry (Wall Plate)', type: 'distance', category: 'Hyrox' },
    { id: 'db_push_press', name: 'Dumbbell Push Press', type: 'reps', category: 'Hyrox' },
    { id: 'bear_crawl', name: 'Bear Crawl', type: 'distance', category: 'Hyrox' },
    { id: 'wp_clean_press', name: 'Clean & Press (Wall Plate)', type: 'reps', category: 'Hyrox' },
    { id: 'wp_overhead_carry', name: 'Overhead Carry (Wall Plate)', type: 'distance', category: 'Hyrox' },
    { id: 'devil_press', name: 'Devil Press (DB)', type: 'reps', category: 'Hyrox' },
    ...
    // === OBSTACLE RACING ===
    { id: 'sanggup', name: 'Sanggup (Weighted Push)', type: 'reps', category: 'Obstacle' },
    { id: 'thor', name: 'Thor (Hammer Throw)', type: 'reps', category: 'Obstacle' },
    { id: 'bars', name: 'Monkey Bars', type: 'reps', category: 'Obstacle' },
    { id: 'multirig', name: 'Multi-Rig', type: 'reps', category: 'Obstacle' },
    { id: 'low_rig', name: 'Low Rig (Traverse)', type: 'distance', category: 'Obstacle' },
    { id: 'caddylack', name: 'Caddylack (Tyre Hammer)', type: 'distance', category: 'Obstacle' },
    { id: 'nutmeh', name: 'Nutmeh (Puzzle)', type: 'time', category: 'Obstacle' },
    { id: 'wringer', name: 'Wringer (Forearm Rope Roll)', type: 'reps', category: 'Obstacle' },
    { id: 'rope_climb_obstacle', name: 'Rope Climb', type: 'reps', category: 'Obstacle' },
...
export const MOCK_WORKOUTS: Workout[] = [
  ...
  {
    id: 'w_hyrox_open_men',
    name: 'HYROX Individual Open (Men)',
    description: 'Official HYROX race format for Men\'s Open division. 8 x 1km runs + 8 functional stations.',
    scheme: WorkoutScheme.FOR_TIME,
    ...
    components: [
      ...
      { exercise_id: 'ski', target: '1000m Ski Erg', order: 2 },
      { exercise_id: 'run', target: '1km Run', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push', weight: '102kg', order: 4 },
      { exercise_id: 'run', target: '1km Run', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull', weight: '78kg', order: 6 },
      { exercise_id: 'run', target: '1km Run', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump', order: 8 },
      { exercise_id: 'run', target: '1km Run', order: 9 },
      { exercise_id: 'row', target: '1000m Row', order: 10 },
      { exercise_id: 'run', target: '1km Run', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry', weight: '2x24kg', order: 12 },
      { exercise_id: 'run', target: '1km Run', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges', weight: '20kg', order: 14 },
      { exercise_id: 'run', target: '1km Run', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls', weight: '6kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Men\'s Open: Sled 102/78kg, Farmers 2x24kg, Sandbag 20kg, WB 6kg',
      [ScalingTier.ADVANCED]: 'Reduce sled weight by 10kg',
      [ScalingTier.INTERMEDIATE]: '50% reps/distance, lighter weights',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  {
    id: 'w_hyrox_open_women',
    name: 'HYROX Individual Open (Women)',
    description: 'Official HYROX race format for Women\'s Open division. 8 x 1km runs + 8 functional stations.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    ...
    components: [
      ...
      { exercise_id: 'ski', target: '1000m Ski Erg', order: 2 },
      { exercise_id: 'run', target: '1km Run', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push', weight: '70kg', order: 4 },
      { exercise_id: 'run', target: '1km Run', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull', weight: '52kg', order: 6 },
      { exercise_id: 'run', target: '1km Run', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump', order: 8 },
      { exercise_id: 'run', target: '1km Run', order: 9 },
      { exercise_id: 'row', target: '1000m Row', order: 10 },
      { exercise_id: 'run', target: '1km Run', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry', weight: '2x16kg', order: 12 },
      { exercise_id: 'run', target: '1km Run', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges', weight: '10kg', order: 14 },
      { exercise_id: 'run', target: '1km Run', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls', weight: '4kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Women\'s Open: Sled 70/52kg, Farmers 2x16kg, Sandbag 10kg, WB 4kg',
      [ScalingTier.ADVANCED]: 'Reduce sled weight by 10kg',
      [ScalingTier.INTERMEDIATE]: '50% reps/distance, lighter weights',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  ...
  {
    id: 'w_hyrox_pro_men',
    name: 'HYROX Individual Pro (Men)',
    description: 'Official HYROX race format for Men\'s Pro division. Elite weights. 8 x 1km runs + 8 functional stations.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    ...
    scaling: {
      [ScalingTier.RX]: 'Men\'s Pro: Sled 152/103kg, Farmers 2x32kg, Sandbag 30kg, WB 9kg',
      [ScalingTier.ADVANCED]: 'Open weights (102/78kg)',
      [ScalingTier.INTERMEDIATE]: '50% reps/distance',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  {
    id: 'w_hyrox_pro_women',
    name: 'HYROX Individual Pro (Women)',
    description: 'Official HYROX race format for Women\'s Pro division. Elite weights. 8 x 1km runs + 8 functional stations.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    ...
    scaling: {
      [ScalingTier.RX]: 'Women\'s Pro: Sled 102/78kg, Farmers 2x16kg, Sandbag 20kg, WB 6kg',
      [ScalingTier.ADVANCED]: 'Open weights (70/52kg)',
      [ScalingTier.INTERMEDIATE]: '50% reps/distance',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  ...
  {
    id: 'w_hyrox_doubles_men',
    name: 'HYROX Men\'s Doubles',
    description: 'HYROX Doubles format for Men. Partners alternate runs and split station work. Open weights.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    category: 'Hyrox',
    components: [
      { exercise_id: 'run', target: '1km Run (P1)', order: 1 },
      { exercise_id: 'ski', target: '1000m Ski Erg (Split)', order: 2 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push (Split)', weight: '102kg', order: 4 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull (Split)', weight: '78kg', order: 6 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump (Split)', order: 8 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 9 },
      { exercise_id: 'row', target: '1000m Row (Split)', order: 10 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry (Split)', weight: '2x24kg', order: 12 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges (Split)', weight: '20kg', order: 14 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls (Split)', weight: '6kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Men\'s Doubles: Partners alternate runs, split stations',
      [ScalingTier.ADVANCED]: 'Reduce sled weight by 10kg',
      [ScalingTier.INTERMEDIATE]: 'Lighter weights, walk breaks allowed',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  {
    id: 'w_hyrox_doubles_women',
    name: 'HYROX Women\'s Doubles',
    description: 'HYROX Doubles format for Women. Partners alternate runs and split station work. Open weights.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    ...
    components: [
      ...
      { exercise_id: 'ski', target: '1000m Ski Erg (Split)', order: 2 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push (Split)', weight: '70kg', order: 4 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull (Split)', weight: '52kg', order: 6 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump (Split)', order: 8 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 9 },
      { exercise_id: 'row', target: '1000m Row (Split)', order: 10 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry (Split)', weight: '2x16kg', order: 12 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges (Split)', weight: '10kg', order: 14 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls (Split)', weight: '4kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Women\'s Doubles: Partners alternate runs, split stations',
      [ScalingTier.ADVANCED]: 'Reduce sled weight by 10kg',
      [ScalingTier.INTERMEDIATE]: 'Lighter weights, walk breaks allowed',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  ...
  {
    id: 'w_hyrox_doubles_mixed',
    name: 'HYROX Mixed Doubles',
    description: 'HYROX Mixed Doubles format. One male + one female partner. Alternate runs and split station work.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    category: 'Hyrox',
    components: [
      { exercise_id: 'run', target: '1km Run (Male)', order: 1 },
      { exercise_id: 'ski', target: '1000m Ski Erg (Split)', order: 2 },
      { exercise_id: 'run', target: '1km Run (Female)', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push', weight: 'M:102kg / F:70kg', order: 4 },
      { exercise_id: 'run', target: '1km Run (Male)', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull', weight: 'M:78kg / F:52kg', order: 6 },
      { exercise_id: 'run', target: '1km Run (Female)', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump (Split)', order: 8 },
      { exercise_id: 'run', target: '1km Run (Male)', order: 9 },
      { exercise_id: 'row', target: '1000m Row (Split)', order: 10 },
      { exercise_id: 'run', target: '1km Run (Female)', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry', weight: 'M:2x24kg / F:2x16kg', order: 12 },
      { exercise_id: 'run', target: '1km Run (Male)', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges', weight: 'M:20kg / F:10kg', order: 14 },
      { exercise_id: 'run', target: '1km Run (Female)', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls (Split)', weight: 'M:6kg / F:4kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Mixed Doubles: Gender-specific weights, alternate runs',
      [ScalingTier.ADVANCED]: 'Reduce weights by 10kg each',
      [ScalingTier.INTERMEDIATE]: 'Lighter weights, walk breaks allowed',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  {
    id: 'w_hyrox_doubles_pro',
    name: 'HYROX Pro Doubles',
    description: 'HYROX Pro Doubles format. Elite weights for both partners. Pro division challenge.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 5400,
    rest_type: 'none',
    is_featured: false,
    ...
    components: [
      ...
      { exercise_id: 'ski', target: '1000m Ski Erg (Split)', order: 2 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 3 },
      { exercise_id: 'sled_push', target: '50m Sled Push (Split)', weight: 'M:152kg / F:102kg', order: 4 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 5 },
      { exercise_id: 'sled_pull', target: '50m Sled Pull (Split)', weight: 'M:103kg / F:78kg', order: 6 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 7 },
      { exercise_id: 'burpee_broad', target: '80m Burpee Broad Jump (Split)', order: 8 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 9 },
      { exercise_id: 'row', target: '1000m Row (Split)', order: 10 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 11 },
      { exercise_id: 'farmers', target: '200m Farmers Carry (Split)', weight: 'M:2x32kg / F:2x16kg', order: 12 },
      { exercise_id: 'run', target: '1km Run (P1)', order: 13 },
      { exercise_id: 'lunge', target: '100m Sandbag Lunges (Split)', weight: 'M:30kg / F:20kg', order: 14 },
      { exercise_id: 'run', target: '1km Run (P2)', order: 15 },
      { exercise_id: 'wallball', target: '100 Wall Balls (Split)', weight: 'M:9kg / F:6kg', order: 16 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Pro Doubles: Pro weights, alternate runs, split stations',
      [ScalingTier.ADVANCED]: 'Open weights',
      [ScalingTier.INTERMEDIATE]: 'Lighter weights, walk breaks allowed',
      [ScalingTier.BEGINNER]: 'Bodyweight movements, walk runs',
    }
  },
  // === DEADLY DOZEN ===
  {
    id: 'w_deadly_dozen_men',
    name: 'Deadly Dozen (Men)',
    description: '12 grueling labours testing strength, endurance, and mental fortitude. Men\'s standard weights.',
    scheme: WorkoutScheme.FOR_TIME,
    ...
    components: [
      ...
      { exercise_id: 'kb_deadlift', target: '60 Kettlebell Deadlifts', weight: '32kg (70 lbs)', order: 2 },
      { exercise_id: 'db_lunge', target: '60m Dumbbell Lunges', weight: '2x12.5kg (30 lbs)', order: 3 },
      { exercise_id: 'db_snatch', target: '60 DB Snatch (Alternate)', weight: '15kg (35 lbs)', order: 4 },
      { exercise_id: 'burpee_broad', target: '60m Burpee Broad Jump', order: 5 },
      { exercise_id: 'goblet_squat', target: '60 Goblet Squats', weight: '16kg (35 lbs)', order: 6 },
      { exercise_id: 'wp_front_carry', target: '240m Front Carry', weight: '25kg (55 lbs)', order: 7 },
      { exercise_id: 'db_push_press', target: '60 Push Press', weight: '2x12.5kg (30 lbs)', order: 8 },
      { exercise_id: 'bear_crawl', target: '120m Bear Crawl', order: 9 },
      { exercise_id: 'wp_clean_press', target: '60 Clean & Press', weight: '15kg (35 lbs)', order: 10 },
      { exercise_id: 'wp_overhead_carry', target: '180m Overhead Carry', weight: '15kg (35 lbs)', order: 11 },
      { exercise_id: 'devil_press', target: '20 Devil Press', weight: '2x10kg (25 lbs)', order: 12 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Men\'s Standard: Full weights as prescribed',
      [ScalingTier.ADVANCED]: 'Reduce all weights by 20%',
      [ScalingTier.INTERMEDIATE]: 'Reduce all weights by 40%, 50% reps/distance',
      [ScalingTier.BEGINNER]: 'Bodyweight only, 50% distance/reps',
    }
  },
  {
    id: 'w_deadly_dozen_women',
    name: 'Deadly Dozen (Women)',
    description: '12 grueling labours testing strength, endurance, and mental fortitude. Women\'s standard weights.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 3600,
    rest_type: 'none',
    is_featured: false,
    ...
    components: [
      ...
      { exercise_id: 'kb_deadlift', target: '60 Kettlebell Deadlifts', weight: '24kg (53 lbs)', order: 2 },
      { exercise_id: 'db_lunge', target: '60m Dumbbell Lunges', weight: '2x7.5kg (20 lbs)', order: 3 },
      { exercise_id: 'db_snatch', target: '60 DB Snatch (Alternate)', weight: '9kg (20 lbs)', order: 4 },
      { exercise_id: 'burpee_broad', target: '60m Burpee Broad Jump', order: 5 },
      { exercise_id: 'goblet_squat', target: '60 Goblet Squats', weight: '12kg (26 lbs)', order: 6 },
      { exercise_id: 'wp_front_carry', target: '240m Front Carry', weight: '20kg (45 lbs)', order: 7 },
      { exercise_id: 'db_push_press', target: '60 Push Press', weight: '2x6kg (15 lbs)', order: 8 },
      { exercise_id: 'bear_crawl', target: '120m Bear Crawl', order: 9 },
      { exercise_id: 'wp_clean_press', target: '60 Clean & Press', weight: '10kg (25 lbs)', order: 10 },
      { exercise_id: 'wp_overhead_carry', target: '180m Overhead Carry', weight: '10kg (25 lbs)', order: 11 },
      { exercise_id: 'devil_press', target: '20 Devil Press', weight: '2x5kg (12 lbs)', order: 12 },
    ],
    scaling: {
      [ScalingTier.RX]: 'Women\'s Standard: Full weights as prescribed',
      [ScalingTier.ADVANCED]: 'Reduce all weights by 20%',
      [ScalingTier.INTERMEDIATE]: 'Reduce all weights by 40%, 50% reps/distance',
      [ScalingTier.BEGINNER]: 'Bodyweight only, 50% distance/reps',
    }
  ...
  // === OBSTACLE RACING WORKOUTS ===
  {
    ...
    components: [
      ...
      { exercise_id: 'sanggup', target: '3 Weighted Pushes', order: 2 },
  ...
  },
  {
    ...
    components: [
      ...
      { exercise_id: 'low_rig', target: '20m Low Rig Traverse', order: 2 },
  ...
  },
  {
    ...
    description: 'Hammer throws combined with heavy carries and strength obstacles.',
    scheme: WorkoutScheme.FOR_TIME,
  ...
  },
  {
    ...
    name: 'Squeeze & Crawl',
    description: 'Navigate through tight spaces - forearm rope rolls, puzzle solving, and crawling obstacles.',
    scheme: WorkoutScheme.FOR_TIME,
    time_cap_seconds: 1800, // 30 mins
    rest_type: 'none',
    is_featured: false,
    category: 'Obstacle',
    components: [
      { exercise_id: 'wringer', target: '1 Complete Roll', order: 1 },
      { exercise_id: 'mud_crawl', target: '30m Low Crawl', order: 2 },
      { exercise_id: 'nutmeh', target: 'Complete Puzzle', order: 3 },
      { exercise_id: 'bear_crawl', target: '40m Bear Crawl', order: 4 },
      { exercise_id: 'caddylack', target: '20m Hammer', order: 5 },
      { exercise_id: 'low_rig', target: '20m Traverse', order: 6 },
      { exercise_id: 'wringer', target: '1 Complete Roll', order: 7 },
    ],
    scaling: {
  ...
  },
  {
    ...
    components: [
      { exercise_id: 'run', target: '1km Run', order: 1 },
      { exercise_id: 'sanggup', target: '2 Weighted Pushes', order: 2 },
      ...
      { exercise_id: 'caddylack', target: '20m Hammer', order: 9 },
